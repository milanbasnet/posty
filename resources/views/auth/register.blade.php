    ...
    <div class="flex justify-center">
        ...
        <form action="{{route('register')}}" method="post" autocomplete="off" >
            ...
            <div class="mb-4">
                ...
                class="bg-gray=100 border-2 w-full p-4 rounded-lg @error('mobile') border-red-500 @enderror">
                @error('mobile')
                    <div class="text-red-500 mt-2 text-sm">
                        {{$message}}
                    </div>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Reenter password" 
                class="bg-gray=100 border-2 w-full p-4 rounded-lg @error('password_confimation') border-red-500 @enderror">
